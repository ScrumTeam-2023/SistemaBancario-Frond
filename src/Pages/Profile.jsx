import { Outlet, Link , useParams} from 'react-router-dom'
  ...
  import { TransactionHistoryPage } from '../Components/Historial/TransactionHistoryPage'
        ...
        <MDBContainer className="py-5">
          ...
          <MDBRow>
            ...
            <MDBCol lg="8">
              ...
              <br></br><span></span>
              <MDBBreadcrumbItem active className='text'><h3>{'   ' + profile.movements}</h3></MDBBreadcrumbItem>
